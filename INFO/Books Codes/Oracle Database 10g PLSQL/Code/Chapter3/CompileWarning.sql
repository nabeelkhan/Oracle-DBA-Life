...
PROMPT
PROMPT
PROMPT ** Set the PLSQL_WARNING level to DISABLE:ALL
PROMPT
PROMPT
...
PROMPT
PROMPT
PROMPT ** Create a procedure that does not include 
PROMPT **  an EXIT WHEN statement in the loop
PROMPT
PROMPT

CREATE OR REPLACE PROCEDURE compile_warning
AS
...
BEGIN
   ...
   -- there should be a line to exit here
   -- like EXIT WHEN dbms_warning_cur%NOTFOUND
...
PROMPT
PROMPT
PROMPT ** The procedure compiles fine
PROMPT
PROMPT
...
PROMPT **  DBMS_WARNING.SET_WARNING_SETTING_STRING('ENABLE:ALL', 'SESSION');
PROMPT
PROMPT
...
PROMPT
PROMPT ** Verify the setting using:
PROMPT **  DBMS_WARNING.GET_WARNING_SETTING_STRING()
PROMPT
PROMPT
...
PROMPT
PROMPT ** Now recompile the same procedure
PROMPT
PROMPT

ALTER PROCEDURE compile_warning COMPILE;

PROMPT
PROMPT ** This shows that there is a warning message.  Type SHOW ERRORS
PROMPT **  to see what the problem is.
PROMPT
PROMPT
