 ...
 *
 * This script builds tables and populates them for chapter 8.
 */
...
REM Becomes an update when merged, because it matches
INSERT INTO competitor_books (isbn, category, title, num_pages, price, copyright)
  VALUES ('72121467', 'Oracle Server', 'Oracle8i Advanced PL/SQL Programming', 772, 59.99, 2000);
...
REM Becomes an update when merged, because it matches
INSERT INTO competitor_books (isbn, category, title, num_pages, price, copyright)
  VALUES ('72121882', 'Oracle Server', 'Oracle8i DBA Handbook', 979, 49.99, 1999);
...
REM Becomes an insert when merged, because it has no match.
INSERT INTO competitor_books (isbn, category, title, num_pages, price, copyright)
  VALUES ('0596002246', 'Web Technologies', 'Web Services Essentials', 290, 29.95, 2002);
...
PROMPT connect_audit...
DROP TABLE connect_audit;
