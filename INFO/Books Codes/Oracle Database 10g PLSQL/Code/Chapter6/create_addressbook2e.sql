 ...
 * in all but one column. It uses a varray of INTEGER for the
 * ADDRESSES.STREET_ADDRESS column. It should only be used to raise an
 * exception error consistent with the example in the book.
 */
