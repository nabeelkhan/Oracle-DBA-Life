...
PROMPT
PROMPT DBMS_JOB.CHANGE example
PROMPT
...
BEGIN
   ...
   DBMS_JOB.CHANGE (JOB => &&job_number, 
...
PROMPT
PROMPT Look at the output and note the change to the INTERVAL.
PROMPT It was 1/48 and now shows as 1/24.
PROMPT
