 ...
 *
 * This script shows how cursors work with the CONTEXT area, and remain
 *   consistent after opened.
 */
...
BEGIN
   ...
   v_rowcount := 0;
   -- Check cursor #2
   FETCH author_cur2 INTO v_rowid;
   IF author_cur2%ROWCOUNT > 0
   THEN
