...
Rem on the write batch size (normally 1024 or 2048 buffers). If the average 
Rem length of the dirty buffer write queue is larger than the value 
Rem calculated before, increase db_file_simultaneous_writes or db_files.
Rem Also check for disks that are doing many more IOs than other disks.
