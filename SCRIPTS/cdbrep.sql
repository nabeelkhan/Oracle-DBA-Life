REM	Description:    The script generates a report of 
rem	tablesapces, data files, roll back segments, 
REM	control files, log files, objects (user wise, valid and invalid)
