Rem
Rem $Header: spup816.sql 18-apr-2002.10:55:19 vbarrier Exp $
Rem
Rem spup816.sql
Rem
...
alter table STATS$SGASTAT drop constraint STATS$SGASTAT_SUMMARY_PK;
...
alter table STATS$SGA drop constraint STATS$SGAXS_PK;
...
sqlstr varchar2(128);
begin
  for tbnam in (select table_name from all_tab_privs
                 where privilege    = 'SELECT' 
                   and table_schema = 'PERFSTAT'
                   and grantee      = 'PUBLIC' )
  loop
